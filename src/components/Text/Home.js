    ...
    >
      ...
      >
        <div
          className={
            light
              ? "db dtc v-mid-ns tl w-100 w-50-ns purple ma3 mt0"
              : "db dtc v-mid-ns tl w-100 w-50-ns gold ma3 mt0"
          }
        >
          <p className="f2 f1-l mb2 mt0 b ">{name}</p>
          ...
          <div className="flex">
            <a
              className={
                light
                  ? "link purple hover-silver dib h2 w2 mr3"
                  : "link gold hover-silver dib h2 w2 mr3"
              }
